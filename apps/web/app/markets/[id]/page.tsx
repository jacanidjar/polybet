...
export default function MarketDetailPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // 1. Fetch main market
                // Support slug lookup implicitly via the backend update we just made? 
                // params.id might be "will-trump-win" or "1". The backend handles both.
                // However, the backend returns the ID as a number.
                ...
                // 2. Fetch related markets (same category)
